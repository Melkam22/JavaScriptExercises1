...
sumOfCubes([3,5,7]);//we ll get the sum of the square cubes of given Nos.
...
monthFinder(20);//12 months called respectively 
...
symmetrical(12353231);//the reverse and not-reverse are equal then symmetrical
...
for(let e=0; e<givenWord2.length; e++) {
 ...
 console.log(givenWord2.charAt[e][1]);
}
